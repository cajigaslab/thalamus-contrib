...
add_custom_command(OUTPUT "${opencv_BINARY_DIR}/$<CONFIG>/CMakeCache.txt"
                   ...
                   cmake "${opencv_SOURCE_DIR}" -Wno-dev 
                      ...
                      -DBUILD_TESTS=OFF -DBUILD_EXAMPLES=OFF -DBUILD_PERF_TESTS=OFF -DBUILD_PROTOBUF=OFF
                      -DBUILD_SHARED_LIBS=OFF -DWITH_EIGEN=OFF -DWITH_ADE=OFF -DOPENCV_PYTHON_SKIP_DETECTION=ON
                      ...
                      -DBUILD_LIST=core,imgproc,imgcodecs,calib3d,flann,features2d,stitching,objdetect
